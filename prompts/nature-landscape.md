# Nature & Landscape Prompts / 自然与风景提示词
...
| Parameter | Purpose | Typical Range (Nature/Landscape) |
|-----------|---------|----------------------------------|
| `--ar`    | Aspect ratio | `16:9` (standard landscape), `21:9` (panoramic) |
| `--s`     | Stylize | `300-500` (higher for aurora/sunset, moderate for documentary) |
| `--c`     | Chaos | `0-15` (keep low for realistic landscapes) |
| `--q`     | Quality | `1` (default) or `2` (max detail for dunes, water) |
| `--v 7`   | Model version | Always use `--v 7` for best landscape rendering |
